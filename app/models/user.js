...
export default DS.Model.extend({
  ...
  personalLibrary: DS.belongsTo('library', {inverse: 'owner'}),
  librariesManager: DS.hasMany('library', {inverse: 'managers'}),
  librariesMember: DS.hasMany('library', {inverse: 'members'}),
  librariesEditor: DS.hasMany('library', {inverse: 'editors'}),
  librariesApprover: DS.hasMany('library', {inverse: 'approvers'}),
