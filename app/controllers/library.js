...
export default Ember.Controller.extend({
  ...
  filteredClauses: Ember.computed('dateFilter', 'favoriteClauses', function() {
    if (this.get('dateFilter') === "u30d") {
      ...
      return this.get('favoriteClauses');
    }
  }),
  updatedLastMonth: Ember.computed.filter('favoriteClauses', function(clause) {
    return moment().diff(clause.get('metadata.lastModified'), 'months') < 1;
  }),
  updatedLast6Months: Ember.computed.filter('favoriteClauses', function(clause) {
